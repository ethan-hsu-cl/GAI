...
CONFIG_MAPPING = {
    ...
    'wan_v3_v2v': 'config/batch_wan_v3_v2v_config.yaml',
...
def show_usage():
    ...
    print("  wan_v3_v2v - Wan V3 video-to-video (/wan_v3, source video as reference video)")
    ...
    print("  python runall.py wan_v3_v2v auto")
